...
public class OverlayCost2 {
	...
	public static void main(String[] a){
		...
		ValidationState small=new ValidationState(); List<Long> e3=new ArrayList<>(); for(int x=0;x<3000;x++) e3.add(LocalPos.pack(x,0,0)); small.beginScan(e3); for(long p: e3) small.setStatus(p, ValidationState.WRONG, "X"); small.endScan();
